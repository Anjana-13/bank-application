...
import {styles} from '../styles/confirm-mobile.styles';
    ...
    <View>
      ...
      <View style={styles.container}>
        <View style={styles.mobile}>
          <Text style={styles.enterMobile}>{'Confirm Mobile number'}</Text>
        </View>
        <View style={styles.digitCode}>
          <Text style={styles.sendCode}>
            {'We send 4 digits code to +91 ' + props.route.params.phoneNumber}
          </Text>
        </View>
      </View>
